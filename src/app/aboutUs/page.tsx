 ...
 const AboutUs = () => {
  return (
    <div className='flex flex-row'>
      <div className="relative w-full h-[500px] content-center align-middle">
      <CldImage
  width="100"
  height="100"
  src="Logo_juzkwh"
  ...
  alt="logo"/>
      ...
      <p>
        ...
        guests, engage in communication, and consistently pursue new flavors and
        experiences. We provide desserts that uniquely reinterpret global
